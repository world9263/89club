			...
			if(true){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($user != null){
						...
						font-weight: bolder;">Company</span>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to<a href="https://89club.sbs" 
						...
						refers to<a href="https://89club.sbs" target="_blank">89 𝐂𝐋𝐔𝐁 Game</a>, accessible from<a href="https://89club.sbs" 
