			...
			if(true){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($user != null){
                        ...
                        $data["list"][0]["bannerUrl"] = "/Banners/1.png";
                        ...
                        $data["list"][1]["bannerUrl"] = "/Banners/2.png";
                        ...
                        $data["list"][2]["bannerUrl"] = "/Banners/6.png";
                        ...
                        $data["list"][3]["bannerUrl"] = "/Banners/4.png";
                        ...
                        $data["list"][4]["bannerUrl"] = "/Banners/5.png";
