    ...
    if (isset($shonupost['typeId'])) {
        ...
        if ($data_auth['status'] === 'Success') {
            ...
            if ($user != null) {
                ...
                $results = k3_ensure_recent_results($firebase, $typeId, 1);
                ...
                if ($latest != null) {
                    $data = [
                        ...
                        'gameType' => isset($latest['gameType']) ? (int)$latest['gameType'] : 0,
                        'sumCount' => isset($latest['sumCount']) ? (int)$latest['sumCount'] : 0,
