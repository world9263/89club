    ...
    if (isset($shonupost['amount']) && isset($shonupost['betCount']) && isset($shonupost['gameType']) && isset($shonupost['issuenumber']) && isset($shonupost['selectType']) && isset($shonupost['typeId'])) {
        ...
        if ($data_auth['status'] === 'Success') {
            ...
            if ($user != null) {
                ...
                $currentPeriod = k3_get_current_period($typeId);
                ...
                if ($gameType == '1' || $gameType == '2' || $gameType == '3' || $gameType == '6' || $gameType == '7' || $gameType == '8' || $gameType == '10') {
                    ...
                    if ($stcnt == 3) $totalamount = $amount * $betCount * 3;
                    elseif ($stcnt == 4) $totalamount = $amount * $betCount * 6;
                    elseif ($stcnt == 5) $totalamount = $amount * $betCount * 10;
                    elseif ($stcnt == 6) $totalamount = $amount * $betCount * 15;
                    else $totalamount = $amount * $betCount;
                } else {
                    $totalamount = $amount * $betCount * $stcnt;
                }
